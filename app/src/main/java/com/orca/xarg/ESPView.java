...
import static com.orca.xarg.Overlay.getConfig;

public class ESPView extends View implements Runnable {

    Paint mStrokePaint;
    Paint mFilledPaint;
    Paint mTextPaint,mNamePaint;
    Thread mThread;
    int FPS = 60;
    ...
    public void DrawText1(Canvas cvs, int a, int r, int g, int b, String txt, float posX, float posY, float size) {
        mTextPaint.setARGB(a, r, g, b);
        mTextPaint.setTextSize(size);
        cvs.drawText(txt,posX - 885, posY + 940, mTextPaint);
    }
    ...
    public void DrawTeamID(Canvas cvs, int a, int r, int g, int b, int teamid, float posX, float posY, float size) {
		...
		//cvs.DrawCurvedRect(posX - 175, posY - 24, posX - 125, posY + 8, mTextPaint);
    }
    ...
    public void DrawDistance(Canvas cvs, int a, int r, int g, int b, String txt, float posX, float posY, float size) {
    ...
    public void DrawTextName(Canvas cvs, int a, int r, int g, int b, String txt, float posX, float posY, float size) {
        ...
        cvs.drawText(txt + mFPS, posX - 885, posY + 940, mTextPaint);
    }
    ...
    public void DrawWeaponIcon(Canvas cvs, int id, float posX, float posY) {
        ...
        if (weapon_icon != 0) {
            bitmap = BitmapFactory.decodeResource(getResources(), weapon_icon);
            out = Bitmap.createScaledBitmap(bitmap, 100, 43, false);
            cvs.drawBitmap(out, posX, posY - 43, null);
        }
    }
