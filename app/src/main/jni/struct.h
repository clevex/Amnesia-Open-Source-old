#ifndef REPUBLIC_CHEAT_IMPORTANT_STRUCT_H
#define REPUBLIC_CHEAT_IMPORTANT_STRUCT_H
...
public:
	...
	static Color Black2(){
		return Color(0,0,0,60);
	}

	static Color White2(){
		return Color(255, 255, 255, 35);
	}

	static Color Green2()
	{
		return Color(0, 255, 0, 35);
	}
	static Color Red2()
	{
		return Color(255, 0, 0, 35);
	}
    static Color Blue()
    {
